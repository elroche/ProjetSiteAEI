    ...
    public static void Init()
    {
        using (var context = new AEIContext())
        {
            if (!context.Articles.Any() && !context.Contacts.Any() && !context.Mandats.Any() && !context.Membres.Any())
            {
                ...
                quEstCeQuneJE.Artice = descriptionJE;
                quiSommesNous.Artice = descriptionJE;
                SICA.Artice = parrainageSICA;
                CRP2022Paragraphe.Artice = CRP2022;
                temoignangeJeanBaptisteParagraphe.Artice = temoignageJeanBaptiste;
                temoignageRealisateurParagraphe.Artice = temoignageRealisateur;
